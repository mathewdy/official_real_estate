        ...
        if(mysqli_num_rows($run_users) > 0){
            foreach($run_users as $row_users){
                ?>
                    ...
                    <a href="edit-profile.php?user_id=<?php echo $row_users['user_id']?>" data-bs-toggle="modal" data-bs-target="#users">
                    ...
                    <div class="modal fade" id="users" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="text" name="middle_name" class="form-control" value="<?php echo $row_users['middle_name']?>" required>
                                <label for="">Last Name:</label>
                                <input type="text" name="last_name" class="form-control" value="<?php echo $row_users['last_name']?>" required>
                                <label for="">Contact Number:</label>
